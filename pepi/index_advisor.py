...
def analyze_single_query(namespace: str, operation: str, pattern: str, stats: Dict) -> Optional[Dict]:
...
def _generate_migration_strategy(namespace: str, current_index: Dict,
...
def _generate_generic_collscan_recommendation(namespace: str, operation: str,
...
def _build_index_spec(fields: List[Tuple[str, str]],
...
def _generate_reason(fields: List[Tuple[str, str]],
...
def _analyze_index_coverage(query_fields: List[Tuple[str, str]],
    ...
    coverage_score = _calculate_coverage_score(query_field_names, query_field_types, index_structure, stats)
...
def _calculate_coverage_score(query_field_names: List[str],
...
def _calculate_esr_score(query_field_types: Dict[str, str],
...
def _validate_esr_compliance(index_structure: List[Tuple[str, int]],
...
def _analyze_selectivity(query_field_types: Dict[str, str],
